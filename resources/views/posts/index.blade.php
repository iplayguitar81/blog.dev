...
<div class="col-md-12">
    <h1>Posts &nbsp;&nbsp;&nbsp;</h1>
    @can('isAdmin') <a href="{{ url('/posts/create') }}" class="btn btn-primary btn-lg">Add New Post</a>@endcan
        ...
        <table class="table">
            ...
            @foreach($posts as $item)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('/posts/' . $item->id . '/edit') }}" class="btn btn-success">{{Auth::user()->name}}- -Update Post<br/><br/> </a>
                        {!! Form::open([
                            'method'=>'DELETE',
                            'url' => ['/posts', $item->id],
